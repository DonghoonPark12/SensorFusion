...
root_path = '/media/deepcv/Samsung_T3/dataset/MV3D/data/raw/kitti/2011_09_26/2011_09_26_drive_0005_sync/'
image_path = root_path + 'image_' + mode + '/data'
velo_path = root_path + 'velodyne_points/data'
xml_path = root_path + 'tracklet_labels.xml'
v2c_filepath = root_path + '../calib_velo_to_cam.txt'
c2c_filepath = root_path + '../calib_cam_to_cam.txt'
frame=89
...
cv2.imshow("3D Tracklet display on image", image)
cv2.waitKey(0)
